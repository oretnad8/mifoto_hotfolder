...
import ValidateButton from "../admin/ValidateButton";
import AutoRefresh from "../components/AutoRefresh";
import PrinterStatusWidget from "../admin/PrinterStatusWidget";
        ...
        return (
            <div className="min-h-screen bg-gray-50 flex flex-col">
                <header className="bg-white shadow-sm p-4">
                    <h1 className="text-xl font-bold text-[#2D3A52] text-center">Acceso Validador</h1>
                </header>
                <div className="flex-1 flex items-center justify-center">
                    <AdminLogin onLogin={(role) => {
                        // Validator page accepts both admin and validator to see this view
                ...
                <header className="flex justify-between items-center mb-10">
                    <div>
                        ...
                        <p className="text-[#2D3A52]/70 mt-2 text-lg">
                            Validación de códigos y entrega
                        </p>
                    </div>
